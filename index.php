...
<head>
    ...
    <!-- SEO Meta -->
    <title>Coursearly - Learn Anytime, Anywhere | Online Education Courses</title>
    <meta name="description" content="Join Coursearly – a modern online education platform offering engaging and affordable courses to empower learners globally. Learn new skills at your own pace." />
    <meta name="keywords" content="Coursearly, online courses, e-learning, education platform, virtual classes, distance learning, online learning, digital academy" />
    <meta name="author" content="Coursearly Team" />
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
    <meta name="googlebot" content="index, follow" />

    <!-- Canonical URL -->
    <link rel="canonical" href="https://Coursearly.com/" />

    <!-- Open Graph (Facebook, LinkedIn) -->
    <meta property="og:title" content="Coursearly - Learn Anytime, Anywhere | Online Education Courses" />
    <meta property="og:description" content="Discover flexible and effective online learning with Coursearly. Access courses in tech, business, design, and more!" />
    <meta property="og:image" content="https://Coursearly.com/assets/images/Coursearly-page-thumbnail.png" />
    <meta property="og:url" content="https://Coursearly.com/" />
    <meta property="og:type" content="website" />
    <meta property="og:site_name" content="Coursearly" />

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Coursearly - Learn Anytime, Anywhere | Online Education Courses" />
    <meta name="twitter:description" content="Explore Coursearly's online courses and gain practical skills to grow your career or business." />
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "Organization",
            "name": "Coursearly",
            "url": "https://Coursearly.com/",
            "logo": "https://Coursearly.com/assets/images/Coursearly-page-thumbnail.png",
            "sameAs": [
                "https://facebook.com/Coursearly",
                "https://twitter.com/Coursearly",
                "https://linkedin.com/company/Coursearly"
            ],
            "description": "Coursearly is an online learning platform that offers a variety of educational courses for students and professionals."
        }
    </script>
...
<body class="element-wrapper">
    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            <main>
                <!-- Start Hero Area -->
                <section class="ed-hero ed-hero--style3">
                    <div class="owl-carousel ed-hero__slider">
                        <!-- Single Slider  -->
                        <div class="ed-hero__slider-item">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7 col-12">
                                ...
                                <div class="ed-hero__content text-center">
                                    <h1 class="ed-hero__content-title text-white ed-split-text left">
                                        Begin Your Learning <br /> Journey Today
                                    </h1>
                                    <div class="ed-hero__search p-0">
                                        ...
                                        <ul class="ed-hero__tags justify-content-center pros_top_category">
                                            <!-- =====PROS LOAD TOP CATEGORY HERE======== -->
                                            <!-- <li><a href="course-1.html">Business</a></li> -->
                                            <!-- <li><a href="course-1.html">Marketing</a></li>
                                            <li><a href="course-1.html">Design</a></li> -->
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="ed-partner__section-head">
                                    <h3 class="ed-partner__section-head-title">Working together with great brands and partners</h3>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="owl-carousel ed-partner__slider">
                                    ...
                                    <a href="#" target="_blank" class="ed-parnet__brand-logo">
                                        <img src="./assets/images/partner/partner-1/1.png" alt="brand-logo" />
                                    </a>
                                    <!-- Single Slider  -->
                                    <a href="#" target="_blank" class="ed-parnet__brand-logo">
                                        <img src="./assets/images/partner/partner-1/2.png" alt="brand-logo" />
                                    </a>
                                    <!-- Single Slider  -->
                                    <a href="#" target="_blank" class="ed-parnet__brand-logo">
                                        <img src="./assets/images/partner/partner-1/3.png" alt="brand-logo" />
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <section class="ed-why-choose ed-why-choose--style3 section-gap position-relative">
                    <img class="ed-w-choose__shape-3" src="assets/images/why-choose/why-choose-3/shape-3.svg" alt="pattern-3" />
                    <div class="container ed-container">
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                <div class="ed-w-choose__content">
                                    <div class="ed-section-head">
                                        <span class="ed-section-head__sm-title">WHO WE ARE</span>
                                        <h3 class="ed-section-head__title ed-split-text left">
                                            Powering growth through <br /> shared knowledge
                                        </h3>
                                        <p class="ed-section-head__text">
                                            We connect creators and learners through a simple platform built to teach, learn, and grow — together.
                                        </p>
                                    </div>
                                    ...
                                    <div class="ed-w-choose__info">
                                        ...
                                        <div class="ed-w-choose__info-single">
                                            ...
                                            <div class="ed-w-choose__info-bottom">
                                                <p>
                                                    Access practical, on-demand courses designed to boost your skills and confidence.
                                                </p>
                                            </div>
                                        </div>
                                        <!-- Single Info  -->
                                        <div class="ed-w-choose__info-single">
                                            <div class="ed-w-choose__info-head">
                                                ...
                                                <h5>24/7 Access to Instructors</h5>
                                            </div>
                                            <div class="ed-w-choose__info-bottom">
                                                <p>
                                                    Get help when you need it — connect with instructors anytime and keep learning without delays.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="ed-w-choose__images ed-w-choose__images--style3 position-relative">
                                    ...
                                    <div class="ed-w-choose__main-img--style2 position-relative">
                                        <img class="why-choose-img-1" src="assets/images/why-choose/why-choose-3/img-1.jpg" alt="why-choose-img-1" />
                                        <img class="why-choose-img-2" src="assets/images/why-choose/why-choose-3/img-2.jpg" alt="why-choose-img-2" />
                                    </div>
                                    <!-- Counter Card -->
                                    <div class="counter-card updown-ani">
                                        ...
                                        <div class="counter-card__info">
                                            <h4><span class="counter total_students"></span>+</h4>
                                            <p>Enrolled Learners</p>
                                        </div>
                                    </div>
                                    <!-- Shapes Elements -->
                                    <div class="ed-w-choose__shapes">
                                        <img class="ed-w-choose__shape-1 rotate-ani" src="assets/images/why-choose/why-choose-3/shape-1.svg" alt="shape-1" />
                                        <img class="ed-w-choose__shape-2" src="assets/images/why-choose/why-choose-3/shape-2.svg" alt="pattern-2" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ed-funfact__inner">
                            <div class="row g-0 justify-content-between">
                                ...
                                <div class="col-xl-auto col-lg-3 col-md-6 col-6">
                                    <div class="ed-funfact__counter wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                        <h4 class="color-text-1"><span class="counter total_students"></span>+</h4>
                                ...
                                <!-- Single Counter  -->
                                <div class="col-xl-auto col-lg-3 col-md-6 col-6">
                                    <div class="ed-funfact__counter wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                        <h4 class="color-text-2"><span class="counter total_courses"></span>+</h4>
                                        <p>Total Courses</p>
                                    </div>
                                </div>
                                ...
                                <!-- Single Counter  -->
                                <div class="col-xl-auto col-lg-3 col-md-6 col-6">
                                    <div class="ed-funfact__counter wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                        <h4 class="color-text-3"><span class="counter total_instructors"></span>+</h4>
                                        <p>Top instructors</p>
                                    </div>
                                </div>
                                ...
                                <!-- Single Counter  -->
                                <div class="col-xl-auto col-lg-3 col-md-6 col-6">
                                    <div class="ed-funfact__counter wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                                        <h4 class="color-text-4"><span class="counter average_rating"></span>+</h4>
                ...
                <!-- Start Category Area -->
                <section class="ed-category ed-category--style2 section-gap overflow-hidden">
                    <div class="container ed-container">
                        <div class="row">
                            <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="swiper ed-category__slider">
                                <div class="swiper-wrapper load_popular_category">
                                    <!-- Single Coure Card  -->
                                    ...
                                    <!-- <div class="swiper-slide">
                                        <div class="ed-category__card ed-category__card--style2">
                                            <div class="ed-category__img">
                                                <img src="assets/images/category/category-2/img-6.png" alt="category-img" />
                                            </div>
                                            <a href="course-1.html" class="ed-category__content">
                                                <div class="ed-category__icon">
                ...
                <!-- Start Course Area -->
                <section class="ed-course section-gap position-relative background-image" style="background-image: url('./assets/images/section-bg-9.png');">
                    <div class="container ed-container">
                        <div class="row">
                            <div class="col-12">
                                <div class="ed-section-head d-flex-between">
                                    <div class="ed-section-head__info">
                                        ...
                                        <h3 class="ed-section-head__title m-0 ed-split-text left">
                                            Level Up with the Right Course
                                        </h3>
                                    </div>
                                    <div class="ed-section-head__btn">
                                        <a href="./courses/" class="ed-btn">View All Courses<i class="fi fi-rr-arrow-small-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row pros_top_courses">
                            <!-- Single Course Card -->
                            <!-- <div class="col-lg-6 col-xl-4 col-md-6 col-12">
                                <div class="ed-course__card ed-course__card--style3 ed-course__card--style4 wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                    <div class="ed-course__cover">
                                        <a href="course-details.html" class="ed-course__img">
                                            <img src="./assets/images/course/course-4/1.png" alt="course-img" />
                                        </a>
                                    </div>
                                    <div class="ed-course__body">
                                        ...
                                        <div class="ed-course__bottom">
                                            <div class="ed-course__teacher">
                                                <img src="assets/images/course/course-3/course-instructor-thumb-1.jpg" alt="course-instructor-thumb" />
                                                <a href="course-1.html">Laura Martinez</a>
                                            </div>
                                            <span class="ed-course__price">$989.00</span>
                                        </div>
                                    </div>
                                </div>
                            </div> -->
                            ...
                            <!-- Single Course Card -->
                            <!-- <div class="col-lg-6 col-xl-4 col-md-6 col-12">
                                <div class="ed-course__card ed-course__card--style3 ed-course__card--style4 wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                    <div class="ed-course__cover">
                                        <a href="course-details.html" class="ed-course__img">
                                            <img src="./assets/images/course/course-4/2.png" alt="course-img" />
                                        </a>
                                    </div>
                                    <div class="ed-course__body">
                                        <div class="ed-course__rattings mg-btm-10">
                                        ...
                                        <div class="ed-course__bottom">
                                            <div class="ed-course__teacher">
                                                <img src="assets/images/course/course-3/course-instructor-thumb-2.jpg" alt="course-instructor-thumb" />
                                                <a href="course-1.html">Elizabeth White</a>
                                            </div>
                            ...
                            <!-- Single Course Card -->
                            <!-- <div class="col-lg-6 col-xl-4 col-md-6 col-12">
                                <div class="ed-course__card ed-course__card--style3 ed-course__card--style4 wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                    <div class="ed-course__cover">
                                        <a href="course-details.html" class="ed-course__img">
                                            <img src="./assets/images/course/course-4/3.png" alt="course-img" />
                                        </a>
                                    </div>
                                    <div class="ed-course__body">
                                        <div class="ed-course__rattings mg-btm-10">
                                        ...
                                        <div class="ed-course__bottom">
                                            <div class="ed-course__teacher">
                                                <img src="assets/images/course/course-3/course-instructor-thumb-3.jpg" alt="course-instructor-thumb" />
                                                <a href="course-1.html">Robert Taylor</a>
                                            </div>
                                            <span class="ed-course__price">$275.00</span>
                                        </div>
                                    </div>
                            ...
                            <!-- <div class="col-lg-6 col-xl-4 col-md-6 col-12">
                                <div class="ed-course__card ed-course__card--style3 ed-course__card--style4 wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                    <div class="ed-course__cover">
                                        <a href="course-details.html" class="ed-course__img">
                                            <img src="./assets/images/course/course-4/4.png" alt="course-img" />
                                        </a>
                                    </div>
                                    <div class="ed-course__body">
                                        <div class="ed-course__rattings mg-btm-10">
                                        ...
                                        <div class="ed-course__bottom">
                                            <div class="ed-course__teacher">
                                                <img src="assets/images/course/course-3/course-instructor-thumb-4.jpg" alt="course-instructor-thumb" />
                                                <a href="course-1.html">James Harris</a>
                                            </div>
                                            <span class="ed-course__price">$426.00</span>
                                        </div>
                                    </div>
                                </div>
                            </div> -->
                            ...
                            <!-- <div class="col-lg-6 col-xl-4 col-md-6 col-12">
                                <div class="ed-course__card ed-course__card--style3 ed-course__card--style4 wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                    <div class="ed-course__cover">
                                        <a href="course-details.html" class="ed-course__img">
                                            <img src="./assets/images/course/course-4/5.png" alt="course-img" />
                                        </a>
                                    </div>
                                    <div class="ed-course__body">
                                        <div class="ed-course__rattings mg-btm-10">
                                        ...
                                        <div class="ed-course__bottom">
                                            <div class="ed-course__teacher">
                                                <img src="assets/images/course/course-3/course-instructor-thumb-5.jpg" alt="course-instructor-thumb" />
                                                <a href="course-1.html">Emily Johnson</a>
                                            </div>
                                            <span class="ed-course__price">$642.00</span>
                                        </div>
                                    </div>
                                </div>
                            </div> -->
                            ...
                            <!-- <div class="col-lg-6 col-xl-4 col-md-6 col-12">
                                <div class="ed-course__card ed-course__card--style3 ed-course__card--style4 wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                    <div class="ed-course__cover">
                                        <a href="course-details.html" class="ed-course__img">
                                            <img src="./assets/images/course/course-4/6.png" alt="course-img" />
                                        </a>
                                    </div>
                                    <div class="ed-course__body">
                                        <div class="ed-course__rattings mg-btm-10">
                                        ...
                                        <div class="ed-course__bottom">
                                            <div class="ed-course__teacher">
                                                ...
                                                <a href="course-1.html">Sarah Davis</a>
                                            </div>
                                            <span class="ed-course__price">$296.00</span>
                                        </div>
                                    </div>
                                </div>
                            </div> -->
                    ...
                    <div class="container ed-container">
                        <div class="ed-call-action__inner ed-call-action__inner--style2">
                            <div class="ed-call-action__shapes">
                                <img class="ed-call-action__shape-1" src="assets/images/abstracts/abstract-element-regular.svg" alt="abstract-element-regular" />
                                <img class="ed-call-action__shape-2" src="assets/images/abstracts/abstract-dot-4.svg" alt="abstract-dot-4" />
                                <img class="ed-call-action__shape-3" src="assets/images/abstracts/abstract-element-regular.svg" alt="abstract-element-regular" />
                                <img class="ed-call-action__shape-4" src="assets/images/abstracts/abstract-orange-plus-1.svg" alt="abstract-orange-plus-1" />
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                ...
                                <div class="col-lg-6 col-12 order-class">
                                    <div class="ed-call-action__content">
                                        <div class="ed-section-head">
                                            <span class="ed-section-head__sm-title">ONLINE COURSES</span>
                                            <h3 class="ed-section-head__title ed-split-text left">
                                                Build Your Future, <br />One Course at a Time
                                            </h3>
                                            <p class="ed-section-head__text">
                                                Start learning what matters most — your journey
                                                <br /> your pace, your success.
                                            </p>
                                        </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-12">
                                ...
                                <div class="ed-about__content p-0">
                                    <div class="ed-section-head">
                                        <span class="ed-section-head__sm-title">WHY CHOOSE Coursearly</span>
                                        <h3 class="ed-section-head__title ed-split-text left">
                                            Learn Creatively. <br /> Grow Confidently.
                                        </h3>
                                        <p class="ed-section-head__text">
                                            We’re building Africa’s digital future — one learner at a time. With expert instructors, flexible tools, and a practical curriculum, Coursearly gives you the edge you need to succeed.
                                        </p>
                                    </div>
                                    <div class="ed-about__feature">
                                        <ul class="ed-about__features-list">
                                            <li><img src="assets/images/icons/icon-check-blue.svg" alt="icon-check-blue" />Expert-Led Courses</li>
                                            <li><img src="assets/images/icons/icon-check-blue.svg" alt="icon-check-blue" />100% Online & Flexible</li>
                                            <li><img src="assets/images/icons/icon-check-blue.svg" alt="icon-check-blue" />Clear, Practical Curriculum</li>
                                            <li><img src="assets/images/icons/icon-check-blue.svg" alt="icon-check-blue" />Learn Once, Use for Life</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-12">
                                ...
                                <div class="ed-about__images">
                                    <div class="ed-about__main-img">
                                        <img src="assets/images/about/about-3/about-img.jpg" alt="about-img" />
                                    </div>
                                    <div class="counter-card updown-ani">
                                        <div class="counter-card__icon">
                                            <i class="fi fi-rr-graduation-cap"></i>
                                    ...
                                    <div class="ed-about__shapes">
                                        ...
                                        <img class="ed-about__shape-2" src="assets/images/about/about-1/shape-2.svg" alt="shape-2" />
                                        <img class="ed-about__shape-3 rotate-ani" src="assets/images/about/about-1/shape-3.svg" alt="shape-3" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section class="ed-testimonial ed-testimonial--style3 section-gap pt-0 overflow-hidden">
                    <div class="container ed-container">
                        <div class="row justify-content-center">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="swiper ed-testimonial__slider-2">
                                <div class="swiper-wrapper testimonials_container">
                                    <!-- Single Testimonial  -->
                                    <div class="swiper-slide">
                                        <div class="ed-testimonial__slider-item bg-color-1">
                                    ...
                                    <!-- Single Testimonial  -->
                                    <div class="swiper-slide">
                                        <div class="ed-testimonial__slider-item bg-color-4">
                                            <ul class="ed-testimonial__rattings">
                                                <li><i class="icofont-star"></i></li>
                                                <li><i class="icofont-star"></i></li>
                                                <li><i class="icofont-star"></i></li>
                ...
                <!-- Start Contact Area -->
                <section class="ed-contact section-gap position-relative pb-0">
                    <div class="ed-contact__bg">
                        <img src="assets/images/contact/contact-bg.png" alt="contact-bg" />
                    </div>
                    <div class="ed-contact__shapes">
                        <img class="ed-contact__shape-1 rotate-ani" src="assets/images/contact/shape-1.svg" alt="shape-1" />
                    ...
                    <div class="container ed-container">
                        <div class="row align-items-end">
                            <div class="col-lg-3 col-12">
                                <div class="ed-contact__info-wrapper">
                                    <h4 class="ed-contact__info-title">Contact</h4>
                                ...
                                <div class="ed-contact__form wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                    <div class="ed-contact__form-head">
                                        ...
                                        <h3 class="ed-contact__form-big-title">
                                            Have Any Questions About Coursearly? Contact With Us Today
                                        </h3>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="ed-contact__form-btn">
                                                    <button type="submit" class="ed-btn">Send Your Message<i class="fi fi-rr-arrow-small-right"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
            ...
            <div class="footer-bg position-relative">
                <div class="footer-bg__img">
                    <img src="assets/images/footer/footer-2/footer-bg.png" alt="footer-bg-img" />
                </div>
                ...
                <!-- Start Footer Area -->
                <footer class="ed-footer position-relative" id="footer">
    ...
    <script>
        $(document).ready(function() {
            // $('#menu-query').load('includes/menu.php');
    ...
    <!-- API JS BY PROS HERE -->
    <script src="controller/js/dash-data.js"></script>
