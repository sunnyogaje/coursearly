...
<head>
    ...
    <!-- Title & Description -->
    <title>Sign Up | Coursearly</title>
    <meta name="description" content="Create your Coursearly account to start learning new skills, track your progress, and access exclusive content." />
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(../assets/assets/images/background/login-register.png);">
        <div class="login-box card">
            <div class="card-body m-t-20">
                <form id="signupForm" class="form-horizontal form-material" style="padding: 10px;" >
                    <div class="offcanvas-logo">
                        <a href="../"><img src="../assets/images/logo.svg" width="220" alt="#" /></a>
                    </div>
                    <h3 class="box-title m-t-40 m-b-0">Sign up with email</h3>
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button type="submit" id="pros_sign_upbtn" 
                            class="btn btn-info btn-md btn-lg btn-block
                             waves-effect waves-light"
                              style="background-color: #009f91;border:none;">
                    ...
                    <div style="text-align: center; padding: 20px; width: 400px;">
                        ...
                        <div style="display: flex; align-items: center; margin-bottom: 30px; color: #666;">
                            ...
                            <small>Other sign up options</small>
                        ...
                        <div style="display: flex; justify-content: space-around; margin-bottom: 30px;">
                            ...
                            style="border: 1px solid #009f91; border-radius: 10px; padding: 5px 10px; width: 50px; height: 50px; display: flex; align-items: center; justify-content: center;cursor:pointer;">
                        ...
                        <div style="font-size: 12px; color: #555; margin-bottom: 20px;">
                            By signing up<br>You agree to our
                            <a href="../term-and-conditions/" style="color: #009f91; text-decoration: underline;">Terms of Use</a> and
                            <a href="../privacy-policy/" style="color: #009f91; text-decoration: underline;">Privacy Policy</a>.
                        </div>

                        <div style="background: #f3f3fa; padding: 15px; font-size: 14px; color: #444;">
                            Already have an account?
                            <a href="../sign-in/" style="color: #009f91; font-weight: bold; text-decoration: underline;">Sign In</a>
                        </div>
