...
<head>
    ...
    <!-- Title -->
    <title>My Courses | Explore Courses</title>
                        ...
                        <div style="border: 1px solid #e5e5e5; border-radius: 12px; overflow: hidden; background: #fff; box-shadow: 0 4px 10px rgba(0,0,0,0.05); font-family: Arial, sans-serif;">
                            ...
                            <div style="padding: 15px;">
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center; font-size: 14px;">
                                    <span style="font-weight: bold; color: #009f91; font-size: 14px;">0 of 32 Complete</span>
                                    <span style="color: #555;"><a href="../learn/" type="button" class="btn waves-effect waves-light btn-sm p-10" style="background-color:#009f91;color:#ffffff;font-size:13px;outline: none; box-shadow: none;">Start Learning</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 m-b-15">
                        <div style="border: 1px solid #e5e5e5; border-radius: 12px; overflow: hidden; background: #fff; box-shadow: 0 4px 10px rgba(0,0,0,0.05); font-family: Arial, sans-serif;">
                            ...
                            <div style="padding: 15px;">
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center; font-size: 14px;">
                                    <span style="font-weight: bold; color: #009f91; font-size: 14px;">0 of 32 Complete</span>
                                    <span style="color: #555;"><a href="../learn/" type="button" class="btn waves-effect waves-light btn-sm p-10" style="background-color:#007ffb;color:#ffffff;font-size:13px;outline: none; box-shadow: none;">Continue Learning</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
